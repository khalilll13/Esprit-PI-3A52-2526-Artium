...
final class CollectionsControllerTest extends WebTestCase
{
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            'collection[titre]' => 'Testing',
            'collection[description]' => 'Testing',
            'collection[artiste]' => 'Testing',
        ]);
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            'collection[titre]' => 'Something New',
            'collection[description]' => 'Something New',
            'collection[artiste]' => 'Something New',
        ]);
